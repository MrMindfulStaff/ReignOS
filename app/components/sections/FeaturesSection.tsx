        ...
        >
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              ...
              <div className="mx-auto mb-4 w-56 h-56 md:w-72 md:h-72 rounded-full bg-white/50 backdrop-blur-sm flex items-center justify-center">
                <img
                  src="/rtr-logo.png"
